 ...
 * @access private
 */
class Simple_Paywall_WP_List_Table {
...
<?php
	...
	protected function pagination( $which ) {
		...
		/**
		 * Modified to add additional query arguments so if search query is set, pagination works for this as well
		 * The original code is to be kept and commented out
	...
	protected function get_primary_column_name() {
		...
		if ( ! isset( $columns[ $default ] ) ) {
			...
			$default = Simple_Paywall_WP_List_Table::get_default_primary_column_name();
		}
